    ...
    return (
        <footer className="flex flex-col gap-6 px-5 py-10 bg-gray-800 text-white text-center @container">
            {/* <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href="#">
                    <div className="text-[#baa99c]" data-icon="InstagramLogo" data-size="24px" data-weight="regular">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                            <path
                ...
                <a href="#">
                    <div className="text-[#baa99c]" data-icon="LinkedinLogo" data-size="24px" data-weight="regular">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                            <path
